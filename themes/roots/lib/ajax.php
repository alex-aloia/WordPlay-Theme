...
function portfolio_item_request() {
...
add_action( 'wp_ajax_portfolio_item_request', 'portfolio_page_request' );
add_action( 'wp_ajax_nopriv_portfolio_item_request', 'portfolio_page_request' );