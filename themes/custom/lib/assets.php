...
function custom_scripts() {
  ...
  if (!is_admin() && current_theme_supports('jquery-cdn')) {
    ...
    add_filter('script_loader_src', 'custom_jquery_local_fallback', 10, 2);
  }
...
function custom_jquery_local_fallback($src, $handle = null) {
...
add_action('wp_head', 'custom_jquery_local_fallback');
