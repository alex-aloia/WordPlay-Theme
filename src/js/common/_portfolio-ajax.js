...
function portClose() {
    ...
    portCloseTL
        ...
        .set(portfolio, {'z-index': '-9', 'display':'none'})
        .call(defObj.resolve);
...
var loadPortfolioDetail = function (d) {
    ...
    function createCloseBtn() {
        ...
        closeBtn
            ...
            .on('mousedown', function () {
                closeBtnTL.reverse();
                TweenLite.to(imgContainer, 0.6, {autoAlpha: 0});
                TweenLite.to(txtContainer, 0.6, {autoAlpha: 0, onComplete: closeDetail});
            })
    }
    ...
    function animateDetail() {
        var $window = $(window),
            detTL = new TimelineLite({delay: 1.25})
            .to(imgContainer, 3, {autoAlpha: 1})
            .to(txtContainer, 3, {autoAlpha: 1}, 0)
